...
//////////////  init /////////////////////////
  onLoad: function (options) {
    ...
    if (options.tapIndex == 1) {
      ...
      wx.chooseImage({
        ...
        success(res) {
          ...
          console.log(res)
          // const tempFilePaths = res.tempFilePaths
          var filePath = res.tempFilePaths //图片临时地址
          console.log(filePath)
          that.creat_img(filePath)
    ...
    var filePath = wx.getStorageSync('image_c') //图片临时地址
    console.log('crex:'+filePath)
